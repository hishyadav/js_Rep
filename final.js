...
document.write('<script src="//www.mdui.org/source/dist/js/mdui.min.js"></script>')
document.write('<style>.mdui-list-item-icon~.mdui-list-item-content {margin-left: 11px;}.mdui-appbar .mdui-toolbar{height:56px;font-size:1pc}.mdui-toolbar>*{padding:0 6px;margin:0 2px}.mdui-toolbar>i{opacity:.5}.mdui-toolbar>.mdui-typo-headline{padding:0 1pc 0 0}.mdui-toolbar>i{padding:0}.mdui-toolbar>a:hover,a.active,a.mdui-typo-headline{opacity:1}.mdui-container{max-width:980px}.mdui-list-item{transition:none}.mdui-list>.th{background-color:initial}.mdui-list-item>a{width:100%;line-height:3pc}.mdui-list-item{margin:2px 0;padding:0}.mdui-toolbar>a:last-child{opacity:1}@media screen and (max-width:980px){.mdui-list-item .mdui-text-right{display:none}.mdui-container{width:100%!important;margin:0}.mdui-toolbar>.mdui-typo-headline,.mdui-toolbar>a:last-child,.mdui-toolbar>i:first-child{display:block}} @media (max-width: 540px){.mdui-drawer{max-width:190px}}</style>');
// 初始化页面，并载入必要资源
function init() {
    document.siteName = $('title').html();
    $('body').addClass("mdui-theme-primary-teal mdui-theme-accent-teal mdui-theme-layout-dark");
    var html = `
	<div class="mdui-drawer mdui-drawer-close" id="drawer" >
  <ul class="mdui-list">
    <li class="mdui-list-item mdui-ripple" onClick = 'ToggleModal()'  style = "padding-left : 4%">
      <i class="mdui-list-item-icon mdui-icon material-icons">perm_contact_calendar</i>
      <div class="mdui-list-item-content">Contact</div>
    </li>
	<li class="mdui-list-item mdui-ripple" onClick = 'ToggleClass()' style = "padding-left : 4%">
      <i class="mdui-list-item-icon mdui-icon material-icons">sync_alt</i>
      <div class="mdui-list-item-content">Switch Theme</div>
    </li>
  </ul>
</div>
...
<div class="mdui-dialog" id="ContactModal">
    <div class="mdui-dialog-content">Created By Hitesh Yadav | <a style = 'color: inherit;' href = 'https://fb.com/hishyadav1997' target="_blank">Facebook</a>
	<a style = 'color: inherit;' href = 'https://instagram.com/hishyadav' target="_blank">Instagram</a>
	<a style = 'color: inherit;' href = 'https://tiktok.com/@hishyadav' target="_blank">TikTok</a></div>
...
function nav(path) {
    var html = "";
    html += `<i onClick = 'toggle()' style = "cursor : pointer" class="mdui-list-item-icon mdui-icon material-icons">menu</i><a href="/" class="mdui-typo-headline folder">${document.siteName}</a>`;
